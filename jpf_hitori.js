...
function switchPuzzle(e){
   ...
   switch(puzzleID){
      case "puzzle1":
         ...
         break;
      case  "puzzle2":
         document.getElementById("puzzle").innerHTML = drawPuzzle(hitori2Number, hitori2Blocks, hitori2Rating);
         break;
      case  "puzzle3":
         document.getElementById("puzzle").innerHTML = drawPuzzle(hitori3Number, hitori3Blocks, hitori3Rating);
         break;
   }
   setupPuzzle();
   }
